...
/**
 * @title CuriosCrewToken
 * @dev Curios Crew's token contract.
 */
contract CuriosCrewToken is PausableToken, SuccinctWhitelist {
  string public constant name = "Curios Crew";
